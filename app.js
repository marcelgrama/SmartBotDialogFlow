...
function handleDialogFlowAction(
  ...
  switch (action) {
    case "faq-delvery":
      ...
      // sendTypingOn(sender);
      setTimeout(() => {
        //trebe schimbat sa trimimita qucik replies inloc de buttons ( Europe changes)
        let buttons = [
          {
            type: "web_url",
...
function sendEmail(subject, content) {
  //Send API 400 Bad Request { 2020-12-29T22:31:29.932400+00:00 app[web.1]: message: '(#10) This action was not submitted due to new privacy rules in Europe. See developer documentation for more info.
